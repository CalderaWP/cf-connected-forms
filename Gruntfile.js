    ...
    grunt.initConfig({
        ...
        gitcommit: {
            commit: {
                ...
                files: {
                    src: [ 'package.json', 'readme.txt', 'cf-form-connector.php', 'releases/<%= pkg.name %>-<%= pkg.version %>.zip' ]
                }
            }
        },
        gitpush: {
        ...
        replace: {
            core_file: {
                ...
                replacements: [{
                    ...
                    from: /define\(\s*'CF_FORM_CON_VER',\s*'(.*)'\s*\);/,
                    to: "define( 'CF_FORM_CON_VER', '<%= pkg.version %>' );"
                }]
            }
        }
